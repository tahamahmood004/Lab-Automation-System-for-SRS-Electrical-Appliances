        ...
        <nav class="navbar navbar-expand-lg blur blur-rounded top-0 z-index-3 shadow position-absolute my-3 py-2 start-0 end-0 mx-4">
          <div class="container-fluid">
                <div class="navbar-brand m-0">
                  <img src="../assets/img/1.jpg" class="navbar-brand-img h-100" alt="main_logo">
                </div>
              ...
              <div class="card card-plain mt-8">
                ...
                <div class="card-body">
                  <form role="form" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                    <label>Email</label>
                    <div class="mb-3">
                      <input type="email" class="form-control <?php echo (!empty($email_err)) ? 'is-invalid' : ''; ?>" name="email" placeholder="admin@dashboard.com" value="<?php echo $email; ?>">
                      <span class="invalid-feedback"><?php echo $email_err; ?></span>
                    </div>
                    <label>Password</label>
                    <div class="mb-3">
                    <input type="password" class="form-control <?php echo (!empty($password_err)) ? 'is-invalid' : ''; ?>" name="password" placeholder="Admin123" >
                    ...
                    <div class="text-center">
                      <input type="submit" name="login" value="Sign in" class="btn bg-gradient-info w-100 mt-4 mb-0">
                    </div>
                  </form>
                </div>
